...
ch3=tuple(s) #ch2변수에 s를 튜플로 변환해서 저장
ch4=set(s) #ch4변수에 s를 집합으로 변환해서 저장(중복 제거)
...
print() #한 줄 띄우기
num1=abs(-5) #num1변수에 -5에 절대값 저장
num2=round(4.6) #num2변수에 반올림 값 저장
num3=bin(10) #num3변수에 정수10을 이진수로 변환해서 저장
str1=chr(97) #97에 해당하는 문자 반환
...
print(list(zip('123',('kim','lee','part')))) #문자열과 튜플을 묶어서 리스트 자료형으로 변환
print(tuple(zip('123',('kim','lee','part')))) #문자열과 튜플을 묶어서 리스트 자료형으로 변환
